...
public class Fac 
{
			...
			(
					...
					(
							...
							(
									new ast.type.Int(),
									 "ComputeFac",
									 new util.Flist<ast.dec.T>().addAll(new ast.dec.Dec(new ast.type.Int(), "num")),
									 new util.Flist<ast.dec.T>().addAll(new ast.dec.Dec(new ast.type.Int(), "num_aux")),
									 new util.Flist<ast.stm.T>().addAll
									 (
											 new ast.stm.If
											 (
													 new ast.exp.Lt(new ast.exp.Id("num"), new ast.exp.Num(1)), 
													 new ast.stm.Assign(new ast.exp.Id("num_aux"), new ast.exp.Num(1)), 
													 new ast.stm.Assign
													 (
															 ...
															 (
																	 ...
																	 (
																			 new ast.exp.This(), 
																			 "ComputeFac", 
																			 new util.Flist<ast.exp.T>().addAll
																			 (
																					 new ast.exp.Sub
																					 (
																							 new ast.exp.Id("num"), 
	...
	// class "Doin"
	static ast.classs.Class doin = new ast.classs.Class
			(
					"Doin", null,
					new util.Flist<ast.dec.T>().addAll(), 
					new util.Flist<ast.method.T>().addAll
					(
							...
							(
									...
									new util.Flist<ast.dec.T>().addAll(new ast.dec.Dec(new ast.type.Int(), "sum"), new ast.dec.Dec(new ast.type.Int(), "i")),
									new util.Flist<ast.stm.T>().addAll
									(
											new ast.stm.Assign(new ast.exp.Id("i"), new ast.exp.Num(0)),
											new ast.stm.Assign(new ast.exp.Id("sum"), new ast.exp.Num(0)),
											new ast.stm.While
											(
	...
	public static ast.program.Program prog1 = new ast.program.Program(sum, new util.Flist<ast.classs.T>().addAll(doin));
}
