...
public class PrettyPrintVisitor implements Visitor 
{
	...
	@Override
	public void visit(codegen.bytecode.stm.Iconst s)
	{
		this.isayln("iconst " + s.i);
		return;
	}
	...
	public void visit(codegen.bytecode.classs.Class c)
	{
		...
		try 
		{
			this.writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("test/" + c.id + ".j")));
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
