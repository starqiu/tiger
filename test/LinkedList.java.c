...
struct List * List_Insert(struct List * this, struct Element * new_elem)
{
    ...
    ret_val = (x_7=aux02, x_7->vptr->InitNew(x_7, (struct Element *)new_elem, (struct List *)aux03, 0));
    return aux02;
}
...
struct List * List_Delete(struct List * this, struct Element * e)
{
    ...
    {
        if((x_8=e, x_8->vptr->Equal(x_8, (struct Element *)var_elem)))
        {
            ret_val = 1;
            if(aux04 < 0)
            {
            ...
            else
            {
                ...
                aux05 = (x_10=prev, x_10->vptr->SetNext(x_10, (struct List *)(x_11=aux01, x_11->vptr->GetNext(x_11))));
                System_out_println(0 - 555);
            }
        }
        else
...
int List_Search(struct List * this, struct Element * e)
{
    ...
    while(!var_end)
    {
        if((x_15=e, x_15->vptr->Equal(x_15, (struct Element *)var_elem)))
        {
            int_ret_val = 1;
        }
        else
...
int LL_Start(struct LL * this)
{
    ...
    System_out_println((x_36=head, x_36->vptr->Search(x_36, (struct Element *)el02)));
    System_out_println((x_37=head, x_37->vptr->Search(x_37, (struct Element *)el03)));
    System_out_println(10000000);
    el01 = ((struct Element*)(Tiger_new(&Element_vtable_, sizeof(struct Element))));
    aux01 = (x_38=el01, x_38->vptr->Init(x_38, 28, 35000, 0));
    head = (x_39=head, x_39->vptr->Insert(x_39, (struct Element *)el01));
    aux01 = (x_40=head, x_40->vptr->Print(x_40));
    System_out_println(2220000);
    head = (x_41=head, x_41->vptr->Delete(x_41, (struct Element *)el02));
    aux01 = (x_42=head, x_42->vptr->Print(x_42));
    System_out_println(33300000);
    head = (x_43=head, x_43->vptr->Delete(x_43, (struct Element *)el01));
